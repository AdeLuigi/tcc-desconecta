...
class ScreenTimeBootReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent?) {
        // Só reage ao boot completo (CE storage disponível após unlock)
        // LOCKED_BOOT_COMPLETED é ignorado: o serviço não é directBootAware
        // e acessar CE storage antes do unlock causa crash em muitos ROMs
