...
\usepackage{mdframed}         % Molduras que podem quebrar página
...
% Ambiente para formulários com borda fina que pode se estender por várias páginas
\newmdenv[
  linewidth=0.3pt,
  innerleftmargin=5mm,
...
% Lista personalizada para alternativas com ( )
\newlist{alternativas}{itemize}{1}
\setlist[alternativas]{%
  label={( )},
  labelsep=0.5em,
  leftmargin=2cm, % alinha com o início do parágrafo
  itemsep=0pt,
  topsep=0.2cm
}

% Atalho opcional para alternativas com parênteses
\newcommand{\opcao}{( ) }
